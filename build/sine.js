...
var VerticalBar = React.createClass({displayName: 'VerticalBar',
  render: function() {
    return (
      React.DOM.div( {className:"verticalBar", style:this.props.style}
      )
    );
  }
});
...
var SineBox = React.createClass({displayName: 'SineBox',
  ...
  render: function() {
    ...
    return (
      React.DOM.div( {className:"sineBox"}, 
        verticalBars
      )
    );
  }
